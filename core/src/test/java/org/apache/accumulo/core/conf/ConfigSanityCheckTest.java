...
public class ConfigSanityCheckTest {
  ...
  public void testFail_badCryptoService() {
    m.put(Property.GENERAL_CRYPTO_SERVICE.getKey(), "DoesNotExistCryptoService");
    ConfigSanityCheck.validate(m.entrySet());
  }

  @Test
  public void testPass_defaultCryptoService() {
    m.put(Property.GENERAL_CRYPTO_SERVICE.getKey(),
        Property.GENERAL_CRYPTO_SERVICE.getDefaultValue());
    ConfigSanityCheck.validate(m.entrySet());
  }
}
