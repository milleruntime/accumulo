...
public class ReplicationOperationsImplIT extends ConfigurableMacBase {
  ...
  public void waitsUntilEntriesAreReplicated() throws Exception {
    ...
    m.put(ReplicationSection.COLF, new Text(tableId.getUtf8Bytes()), ProtobufUtil.toValue(stat));
    ...
    bw = conn.createBatchWriter(MetadataTable.NAME, new BatchWriterConfig());
    m = new Mutation(ReplicationSection.getRowPrefix() + file1);
    m.putDelete(ReplicationSection.COLF, new Text(tableId.getUtf8Bytes()));
    bw.addMutation(m);
    bw.flush();
    ...
    m.putDelete(StatusSection.NAME, new Text(tableId.getUtf8Bytes()));
    bw.addMutation(m);
    bw.flush();
  ...
  public void unrelatedReplicationRecordsDontBlockDrain() throws Exception {
    ...
    bw = conn.createBatchWriter(MetadataTable.NAME, new BatchWriterConfig());
    m = new Mutation(ReplicationSection.getRowPrefix() + file1);
    m.put(ReplicationSection.COLF, new Text(tableId1.getUtf8Bytes()), ProtobufUtil.toValue(stat));

    bw.addMutation(m);

    m = new Mutation(ReplicationSection.getRowPrefix() + file2);
    m.put(ReplicationSection.COLF, new Text(tableId2.getUtf8Bytes()), ProtobufUtil.toValue(stat));
    ...
    bw = conn.createBatchWriter(MetadataTable.NAME, new BatchWriterConfig());
    m = new Mutation(ReplicationSection.getRowPrefix() + file1);
    m.putDelete(ReplicationSection.COLF, new Text(tableId1.getUtf8Bytes()));
    bw.addMutation(m);
    bw.flush();
    ...
    bw = ReplicationTable.getBatchWriter(conn);
    m = new Mutation(file1);
    m.putDelete(StatusSection.NAME, new Text(tableId1.getUtf8Bytes()));
    bw.addMutation(m);
    bw.flush();
  ...
  public void inprogressReplicationRecordsBlockExecution() throws Exception {
    ...
    bw = conn.createBatchWriter(MetadataTable.NAME, new BatchWriterConfig());
    m = new Mutation(ReplicationSection.getRowPrefix() + file1);
    m.put(ReplicationSection.COLF, new Text(tableId1.getUtf8Bytes()), ProtobufUtil.toValue(newStatus));
    bw.addMutation(m);
    bw.flush();
    ...
    bw = ReplicationTable.getBatchWriter(conn);
    m = new Mutation(file1);
    m.put(StatusSection.NAME, new Text(tableId1.getUtf8Bytes()), ProtobufUtil.toValue(newStatus));
    bw.addMutation(m);
    bw.flush();
