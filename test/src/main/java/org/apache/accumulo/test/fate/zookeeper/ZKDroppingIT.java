...
public class ZKDroppingIT extends ConfigurableMacBase {
    ...
    public void test() throws Exception {
        ...
        List<ProcessReference> tProcs = new ArrayList<>(cluster.getProcesses().get(ServerType.TABLET_SERVER));
        ...
        try (AccumuloClient client = Accumulo.newClient().from(getClientProperties()).build()) {
            ...
            VerifyIngest.VerifyParams params = new VerifyIngest.VerifyParams(cluster.getClientProperties(), tableName, ROWS);
            params.timestamp = 1;
            params.dataSize = 50;
            params.random = 56;
            params.startRow = 0;
